...
const STYLE = `Photorealistic 3D editorial portrait of an otherworldly creature, chest-up framing, three-quarter angle facing slightly off-camera. Background: warm off-white textured paper backdrop, color #F5F3EE, subtle linen grain, completely empty, no objects. Lighting: soft directional light from camera left, sharp specular reflections where surfaces are reflective. Square 1:1 composition, magazine-editorial framing with intentional negative space on one side. Cyberpunk-meets-haute-couture aesthetic, like a Vogue cover shoot of an alien being. High contrast, slight depth of field, sharp focus on the face. STRICT PALETTE: only matte deep black #111111, signal-red accent #E63B2E (used sparingly for eyes, glowing veins, markings, light), warm beige #E8E4DD (secondary surfaces or fabric), and the off-white background #F5F3EE. No other colors anywhere — no blues, greens, yellows, neon, fluorescent, gold, silver tints. The signal-red is the only saturated color. Avoid: cartoon style, anime aesthetic, soft children's-illustration look, mechanical seams, robot bolts, cluttered backgrounds, multiple subjects, weapons, bright neon glow, sci-fi power-armor, blue/green/teal tints, generic alien tropes.`;
